 ...
 */
@Slf4j
public class SearchFriendHandler extends SimpleChannelInboundHandler<SearchFriendRequest> {
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, SearchFriendRequest msg) throws Exception {
        ...
        ctx.channel().writeAndFlush(searchFriendResponse);
    }
}
